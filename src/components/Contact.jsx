        ...
        <section id="contact" className="section bg-white py-16">
            <div className="container mx-auto px-6 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    <h2 className="headline-2 lg:max-w-[12ch] text-gray-900 reveal-up">
                    ...
                    <div className="flex items-center gap-4 mt-auto">
                        {socialLinks.map(({ href, icon }, key) => (
                            <a
                                ...
                                href={href}
                                target="_blank"
                                className="w-12 h-12 grid place-items-center ring-2 ring-gray-200 rounded-lg transition-colors hover:bg-gray-100 hover:text-gray-900 active:bg-gray-200"
                            >
                                {icon}
                            </a>
                        ))}
                ...
                <form action="https://getform.io/f/broooxna"
                    ...
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            <label htmlFor="name" className="label text-gray-700 reveal-up">
                                Name
                            </label>
                            <input
                                type="text"
                                ...
                                className="text-field text-gray-900 bg-white border-gray-300 focus:ring-sky-400 focus:border-sky-400"
                            />
                        </div>

                        <div className="mb-4">
                            <label htmlFor="email" className="label text-gray-700 reveal-up">
                                Email
                            </label>
                            <input
                                type="email"
                        ...
                        {/* Phone Number Field */}
                        <div className="mb-4">
                            <label htmlFor="phone" className="label text-gray-700 reveal-up">
                                Phone Number
                            </label>
                            <input
                                type="tel"
                    ...
                    <div className="mb-3">
                        <label htmlFor="message" className="label text-gray-700 reveal-up">
                            Message
                        </label>
                        <textarea
                            name="message"
                            ...
                            required
                            placeholder="Hi...."
                            className="text-field text-gray-900 bg-white border-gray-300 focus:ring-sky-400 focus:border-sky-400 resize-y min-h-40 max-h-40"
                        />
                    </div>

                    <button
                        type="submit"
                        className="btn btn-primary w-full justify-center bg-sky-500 text-white hover:bg-sky-400 active:bg-sky-600"
                    >
                        Submit
                    </button>
                </form>
